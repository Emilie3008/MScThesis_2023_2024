...
from extract_input_data import ECCO33,gpt_energy_grid, xgpt_energy_grid, ISOTOPE, eigenbasis, perts, gpt_vector_lethargy_normalised, xgpt_vector, singular_matrix, gpt_vector, extract_myrrha_sensitivities
