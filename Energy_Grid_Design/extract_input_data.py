...
def extract_gpt_sensitivity_coefficients(filepath, zai):
    ...
    fission_index = gpt_reader.perts["fission xs"] # Fission xs perturbation
...
def extract_data():
    ...
    """
    filepath_gpt = os.path.join(main_path,"GPT", "main_sens0.m")
    ...
    return (gpt_vector, gpt_vector_per_unit_lethargy, xgpt_vector, perts, eigenbasis, singular_matrix)

gpt_vector, gpt_vector_lethargy_normalised, xgpt_vector, perts, eigenbasis, singular_matrix  = extract_data()
